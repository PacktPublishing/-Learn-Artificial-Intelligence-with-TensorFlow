workspace(name = "tfcourse")

# NOTE: The following was taken from the TensorFlow Serving github repository.
...
#    reliable downloads.
load("//:workspace.bzl", "tensorflow_http_archive")
...
load("@org_tensorflow//tensorflow:workspace.bzl", "check_bazel_version_at_least", "tf_workspace")
